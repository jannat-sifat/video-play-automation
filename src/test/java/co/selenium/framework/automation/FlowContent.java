...
public class FlowContent {
	...
	public void test() throws InterruptedException, FindFailed {
		...
		Thread.sleep(5000);
		driver.findElement(By.xpath("//body//div[@id='root']//div//div//div//div//div//div//div//div[2]//div[1]//a[1]"))
				.click();

		Thread.sleep(10000);

		assertEquals(driver.findElements(By.className("vjs-play-control")).size(), 1);
